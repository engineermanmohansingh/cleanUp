REM Scripts works absolutely fine for admin level user. For other users, certain folder access may be denied
...
REM Cleanup for temporary internet file directories for current user
